...
public class Simulation {
    public static void main(String[] args) {
        ...
        System.out.println(my_service.sortBooks());
        my_service.analyzeLibrary();
        my_service.findRecommendedBookForUser(u1);
        System.out.println(my_service.uniqueAuthorsRead());
        System.out.println(my_service.findTopReaderOfTheMonth(users,10,2025));
